...
export const async11 = () => {
    ...
    // first line reject causes the promise to be rejected with a new error, that s then caught
    // by the catch block , a promise resolved or rejected produces another promise.
    // since our catch block does not rethrow error, the promise is resolved and returns "nothing
    // then finally executes the last console.log line
    ...
    function availableNeighbors(nest) {
        ...
        let requests = nest.neighbors.map(neighbor => {
            console.log("calling ping for " , neighbor);
